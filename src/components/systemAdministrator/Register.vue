  ...
  <el-col span="14" offset="7" style="margin-top: 3%">
    <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="站点/网点">
        <el-select v-model="ruleForm2.station" :placeholder="ruleForm2.queryStationOptions[0].label" style="width: 300px">
          <el-option span="14" v-for="item in ruleForm2.queryStationOptions" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
