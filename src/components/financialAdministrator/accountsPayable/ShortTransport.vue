      ...
      return {
        ...
        gridOptions: {
          ...
          columnDefs: [
            ...
            {
              headerName: '运单状态', width: 100, field: 'orderState', suppressMenu: true, hide: false, visible: true
            },
            {
              headerName: '开单网点', width: 100, field: 'billBranch', suppressMenu: true, hide: false, visible: true
            },
            {
              headerName: '开单日期',
              width: 200,
