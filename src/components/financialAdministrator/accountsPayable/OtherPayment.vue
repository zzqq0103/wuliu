<template>
  <div>
    ...
    <div>
      ...
      <div>
        <el-form :model="totalForm" ref="totalForm" :inline="true">
          <el-form-item label="运费异动支出:">
            <el-input v-model="totalForm.unActExpenseTotal" style="width: 100px" readonly="true"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </div>
    ...
    <el-dialog :visible.sync="verVisible" size="full" :closeOnClickModal="false">
      <h2 style='text-align:center;margin-top:-2%'>异动支出核销</h2>
