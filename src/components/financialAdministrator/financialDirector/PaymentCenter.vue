      ...
      <div>
        <el-form style="float: left" :model="totalForm" ref="totalForm" :inline="true">
          <el-form-item label="代收手续费合计:">
            <el-input v-model="totalForm.procedureFeeTotal"></el-input>
          </el-form-item>
        </el-form>
      </div>
      <div style="float: right">
      ...
      return {
        ...
        gridOptions: {
          ...
          columnDefs: [
            ...
            {
              headerName: '货款状态', width: 150, field: 'goodsPayState', filter: 'text', hide: false, visible: true
            },
            {
            ...
            {
              headerName: '代收金额', width: 150, field: 'goodsPayment', filter: 'text', hide: false, visible: true
            },
            {
              headerName: '代收日期', width: 150, field: 'collDate', filter: 'text', hide: false, visible: true
            },
            {
              headerName: '归还日期', width: 150, field: 'retuDate', filter: 'text', hide: false, visible: true
            },
            {
              headerName: '收款方式', width: 150, field: 'collPayType', filter: 'text', hide: false, visible: true
            },
            {
              headerName: '还款方式', width: 150, field: 'retuPayMode', filter: 'text', hide: false, visible: true
            },
            {
