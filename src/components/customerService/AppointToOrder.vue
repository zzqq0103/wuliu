<template>
  <div>
    <h2 style="text-align:center">预约单生成订单</h2>
    <el-form ref="form" :model="form">
      ...
      <div style='margin-top:2%;clear:both'>
        ...
        <input class='input col-3' v-model="form.pickUpAdr"></input>
        ...
        <input class='input col-3' v-model="form.receAdr"></input>
