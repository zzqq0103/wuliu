<template>
  <div>
    <div>
      <h2 style="text-align:center">待 接 货 订 单 信 息</h2>
    ...
    return {
      ...
      gridOptions: {
        ...
        columnDefs: [
          ...
          {
            headerName: '单号', width: 120, field: 'orderId', filter: 'text', hide: false
          },
          {
            headerName: '开单时间', width: 120, field: 'orderDate', filter: 'text', hide: false
          },
          {
            headerName: '发货单位', width: 120, field: 'forwarding', filter: 'text', hide: false
          },
          {
            headerName: '发货人姓名', width: 120, field: 'shipper', filter: 'text', hide: false
          },
          {
            headerName: '联系电话', width: 120, field: 'phone', filter: 'text', hide: false
          },
          {
            headerName: '取货地址', width: 120, field: 'receivedAddr', filter: 'text', hide: false
          },
          {
            headerName: '取货货物区域', width: 120, field: 'receivedArea', filter: 'text', hide: false
          },
          {
            headerName: '货物名称', width: 120, field: 'goodsName', filter: 'text', hide: false
          },
          {
            headerName: '货物件数', width: 120, field: 'numbers', filter: 'text', hide: false
          },
          {
            headerName: '货物重量', width: 120, field: 'weight', filter: 'text', hide: false
          },
          {
            headerName: '货物体积', width: 120, field: 'volume', filter: 'text', hide: false
          },
          {
            headerName: '货物包装', field: 'pack', width: 120, filter: 'text', hide: false
          },
          {
            headerName: '接货司机姓名', field: 'driverName', width: 120, filter: 'text', hide: false
          },
          {
            headerName: '接货司机电话', field: 'driverPhone', width: 120, filter: 'text', hide: false
          },
          {
            headerName: '车牌号', field: 'carLicence', width: 120, filter: 'text', hide: false
          },
          {
            headerName: '车吨位', field: 'carTon', width: 120, filter: 'text', hide: false
          },
          {
            headerName: '车容量', field: 'carVolume', width: 120, filter: 'text', hide: false
          },
          {
            headerName: '订单备注', field: 'remarks', width: 120, filter: 'text', hide: false
          }
        ]
      },
      queryItemOptions: [{
