...
<template>
  <div>
    <div>
      <h2 style="text-align:center">已 运 输 订 单 信 息 页</h2>
    ...
    return {
      ...
      gridOptions: {
        ...
        columnDefs: [
          ...
          {
            headerName: '到站', width: 120, field: 'contractPrice', filter: 'text', hide: false
          },
          {
          ...
          {
            headerName: '收货人地址', width: 120, field: 'carType', filter: 'text', hide: false
          },
          {
          ...
          {
            headerName: '总件数', width: 120, field: 'receState', filter: 'text', hide: false
          },
          {
            headerName: '总重量', width: 120, field: 'carState', filter: 'text', hide: false
          },
          {
            headerName: '总体积', width: 120, field: 'carPosition', filter: 'text', hide: false
          },
          {
